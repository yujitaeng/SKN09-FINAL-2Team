...
1. 👤 수령인 정보 요약: 관계, 성별, 나이대, 기념일/상황을 한 문장에 자연스럽게 녹여 설명하세요.  
   - (예: "👤 수령인: 50대이신 어머니의 생신을 맞아 따뜻한 선물을 준비해보려고 하셨군요.")

2. 🎁 추천 이유: 감정, 스타일, 예산 등 조건에 따라 어떤 기준으로 선물을 골랐는지를 이야기처럼 풀어주세요.  
   - (예: "🎁 추천 이유: 평소 실용적이고 감성적인 분위기를 좋아하신다고 하셔서 그런 품목 위주로 추천드려요.")

3. ✨ 선물 꿀팁: 포장, 카드, 전달 방식 등 선물의 전달 순간을 특별하게 만드는 팁을 제안하는 문장을 포함하세요.  
   - (예: "✨ 선물 꿀팁: 짧은 손편지나 향기 나는 포장을 곁들이면 감동이 배가될 거예요.")

4. 💬 다음 유도: 더 좋은 추천을 위한 추가 정보 요청 문장을 **자연스럽게 마지막에 연결**하세요.  
   - (예: "혹시 더 캐주얼한 분위기의 선물이 궁금하시면 언제든 말씀해주세요!")

📎 예시 안내 문구:
👤 수령인: 늘 곁에서 묵묵히 응원해주신 아버지께 감사의 마음을 전하고 싶으시군요.  
🎁 추천 이유: 실용적인 것을 좋아하시는 아버지께는 일상 속에서 자주 사용하실 수 있는 선물이 좋을 것 같아요.  
✨ 선물 꿀팁: 선물을 전하실 때는 “항상 고마워요, 아버지. 당신 덕분에 버틸 수 있었어요.”라는 짧은 메모를 함께 건네보는 건 어떨까요?  
혹시 더 캐주얼한 분위기의 선물이 궁금하시면 언제든 말씀해주세요!
